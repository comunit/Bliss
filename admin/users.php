<?php
 ...
 if(isset($_GET['add'])){
 	...
 	if($_POST){
        ...
        if($emailCount != 0){
 	    ...
 	    $db->query("INSERT INTO users (full_name,email,password,join_date,permissions) values('$name', '$email','$hashed',null,'$permissions')");
 	    $_SESSION['success_flash'] = 'User has been added!';
 	    header('location: users.php');
 		}
 	}
 	?>
 <h2 class="text-centre" style="text-align: center;">Add A New User</h2><hr>
 ...
 <a href="users.php?add=1" class="btn btn-success pull-right" id="add-product-btn" style="margin-top: -40px;">Add New User</a>
 <hr>
